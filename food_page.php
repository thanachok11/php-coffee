...
<div class="content">
    ...
    while ($data = mysqli_fetch_array($result)) {
        ...
        echo "</div>";
        echo "<br>";
        echo "<p class='details'>{$data['food_id']}. {$data['food_name']}   ราคา  {$data['food_price']} บาท</p>";
        echo "<br>";
        echo "<a href='bookingfood.php?food_id={$data['food_id']}&food_name={$data['food_name']}&food_price={$data['food_price']}&username=$username' class='button'>สั่งอาหาร</a><br><br>";
    }
    ?>
    </body>
</html>    